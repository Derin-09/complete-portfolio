...
const Hobbies = () => {
  return (
    <div className='mt-5 md:mt-0 w-full h-full relative select-none'>
      <BackgroundLayout>
        <section className='flex flex-col gap-4 lg:gap-2 items-center justify-center p-5'>
          ...
          {content.map((c, idx) => (
            <div key={idx} className="w-full h-[70px] md:h-[50px] rounded-xl md:flex items-center p-2 px-3  bg-[#191919]">
